...
public class TokenRange implements TBase<TokenRange, TokenRange._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField RPC_ENDPOINTS_FIELD_DESC = new TField("rpc_endpoints", TType.LIST, (short)4);
  private static final TField ENDPOINT_DETAILS_FIELD_DESC = new TField("endpoint_details", TType.LIST, (short)5);
  ...
  static {
    ...
    tmpMap.put(_Fields.ENDPOINTS, new FieldMetaData("endpoints", TFieldRequirementType.REQUIRED, 
        new ListMetaData(TType.LIST, 
            new FieldValueMetaData(TType.STRING))));
    tmpMap.put(_Fields.RPC_ENDPOINTS, new FieldMetaData("rpc_endpoints", TFieldRequirementType.OPTIONAL, 
        new ListMetaData(TType.LIST, 
            new FieldValueMetaData(TType.STRING))));
    tmpMap.put(_Fields.ENDPOINT_DETAILS, new FieldMetaData("endpoint_details", TFieldRequirementType.OPTIONAL, 
        new ListMetaData(TType.LIST, 
            new StructMetaData(TType.STRUCT, EndpointDetails.class))));
  ...
  /** Returns true if field rpc_endpoints is set (has been asigned a value) and false otherwise */
  ...
  /** Returns true if field endpoint_details is set (has been asigned a value) and false otherwise */
  ...
  public int compareTo(TokenRange other) {
    ...
    if (isSetRpc_endpoints()) {
      lastComparison = TBaseHelper.compareTo(this.rpc_endpoints, typedOther.rpc_endpoints);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetEndpoint_details()) {
      lastComparison = TBaseHelper.compareTo(this.endpoint_details, typedOther.endpoint_details);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.rpc_endpoints != null) {
      if (isSetRpc_endpoints()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.rpc_endpoints.size()));
    ...
    if (this.endpoint_details != null) {
      if (isSetEndpoint_details()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.endpoint_details.size()));
