...
public class KeyRange implements TBase<KeyRange, KeyRange._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField ROW_FILTER_FIELD_DESC = new TField("row_filter", TType.LIST, (short)6);
  ...
  static {
    ...
    tmpMap.put(_Fields.END_TOKEN, new FieldMetaData("end_token", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.STRING)));
    tmpMap.put(_Fields.ROW_FILTER, new FieldMetaData("row_filter", TFieldRequirementType.OPTIONAL, 
...
;
  ...
  /** Returns true if field row_filter is set (has been asigned a value) and false otherwise */
  ...
  public int compareTo(KeyRange other) {
    ...
    if (isSetRow_filter()) {
      lastComparison = TBaseHelper.compareTo(this.row_filter, typedOther.row_filter);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.row_filter != null) {
      if (isSetRow_filter()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.row_filter.size()));
