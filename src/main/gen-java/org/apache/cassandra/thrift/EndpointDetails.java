...
public class EndpointDetails implements TBase<EndpointDetails, EndpointDetails._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField DATACENTER_FIELD_DESC = new TField("datacenter", TType.STRING, (short)2);
  private static final TField RACK_FIELD_DESC = new TField("rack", TType.STRING, (short)3);
  ...
  static {
    ...
    tmpMap.put(_Fields.DATACENTER, new FieldMetaData("datacenter", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.STRING)));
    tmpMap.put(_Fields.RACK, new FieldMetaData("rack", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.STRING)));
  ...
  /** Returns true if field datacenter is set (has been asigned a value) and false otherwise */
  ...
  /** Returns true if field rack is set (has been asigned a value) and false otherwise */
  ...
  public int compareTo(EndpointDetails other) {
    ...
    if (isSetDatacenter()) {
      lastComparison = TBaseHelper.compareTo(this.datacenter, typedOther.datacenter);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetRack()) {
      lastComparison = TBaseHelper.compareTo(this.rack, typedOther.rack);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
